import * as xla_data from 'org_xprof/frontend/app/common/interfaces/xla_data.jsonpb_decls';

export type CustomCallSchedule = 'SCHEDULE_NONE' | 'SCHEDULE_LATEST' | 'SCHEDULE_EARLIEST';
  ...
  export type CustomCallApiVersion = 'API_VERSION_UNSPECIFIED' | 'API_VERSION_ORIGINAL' | 'API_VERSION_STATUS_RETURNING';
